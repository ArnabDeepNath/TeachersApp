    ...
    <div className="space-y-6 pb-20">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Choose the best plan for your institute.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3 lg:gap-8 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <ul className="mt-6 space-y-3 flex-1">
            <li className="flex items-center text-sm text-gray-700">
              <CheckCircle className="mr-2 h-4 w-4 text-green-500" /> 1 Device
              License
            </li>
            <li className="flex items-center text-sm text-gray-700">
              <CheckCircle className="mr-2 h-4 w-4 text-green-500" /> Unlimited
              Students
            </li>
            <li className="flex items-center text-sm text-gray-700">
              <CheckCircle className="mr-2 h-4 w-4 text-green-500" /> All Core
              Features
            </li>
          </ul>
        ...
        <div className="flex flex-col rounded-2xl border-2 border-blue-600 bg-white p-6 shadow-lg relative">
          ...
          <ul className="mt-6 space-y-3 flex-1">
            <li className="flex items-center text-sm text-gray-700">
              <CheckCircle className="mr-2 h-4 w-4 text-green-500" /> 1 Year App
              License
            </li>
            <li className="flex items-center text-sm font-semibold text-blue-700">
              <CheckCircle className="mr-2 h-4 w-4 text-blue-500" /> 5,000 SMS
              Credits
            </li>
            <li className="flex items-center text-sm text-gray-700">
              <CheckCircle className="mr-2 h-4 w-4 text-green-500" /> Priority
              Support
            </li>
          </ul>
